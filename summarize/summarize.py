...
### FCR added
# check http://textminingonline.com/dive-into-nltk-part-ii-sentence-tokenize-and-word-tokenize
...
class Summary(object):
    ...
    def __unicode__(self):
        ...
        # I need only the summarized text, so I edited the line above to:
        return u('{}'.format('\n\n'.join(self.summaries)))
